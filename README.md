claude --resume d4e5345e-16fb-4430-8aac-27d6759e9f1f
...
### Разработка для Jira
+ [Разработка для Jira](#разработка-для-jira) ![icon][done]
...
### Архитектура
+ [Мониторинг и Observability](#мониторинг-и-observability) ![icon][done]
+ [Кэширование](#кэширование) ![icon][done]
...
### Общие вопросы
+ [Какие платформы разработки для Jira существуют?](jira.md#Какие-платформы-разработки-для-Jira-существуют)
+ [Какие существуют способы расширения Jira?](jira.md#Какие-существуют-способы-расширения-Jira)
+ [Что такое Jira REST API и как с ним работать?](jira.md#Что-такое-Jira-REST-API-и-как-с-ним-работать)
+ [Что такое JQL?](jira.md#Что-такое-JQL-Jira-Query-Language)
+ [Что такое Webhooks в Jira?](jira.md#Что-такое-Webhooks-в-Jira-и-как-их-использовать)
+ [Как интегрировать внешнее Spring-приложение с Jira?](jira.md#Как-интегрировать-внешнее-Spring-приложение-с-Jira)

### Jira Data Center (P2 плагины)
+ [Что такое Atlassian SDK и как создать плагин?](jira.md#Что-такое-Atlassian-SDK-и-как-создать-плагин)
+ [Что такое atlassian-plugin.xml и какие модули плагина существуют?](jira.md#Что-такое-atlassian-pluginxml-и-какие-модули-плагина-существуют)
+ [Как работает Spring в плагинах Jira Data Center?](jira.md#Как-работает-Spring-в-плагинах-Jira-Data-Center)
+ [Что такое Active Objects?](jira.md#Что-такое-Active-Objects-и-как-с-ними-работать)
+ [Как создать REST-эндпоинт в плагине?](jira.md#Как-создать-REST-эндпоинт-в-плагине-Jira-DC)
+ [Как создать Custom Field Type?](jira.md#Как-создать-Custom-Field-Type)
+ [Как создать Workflow Post-Function, Condition, Validator?](jira.md#Как-создать-Workflow-Post-Function-Condition-Validator)
+ [Как работать с Event Listener в плагине?](jira.md#Как-работать-с-Event-Listener-в-плагине)
+ [Как работает кластеризация в Jira DC и как это влияет на плагины?](jira.md#Как-работает-кластеризация-в-Jira-Data-Center-и-как-это-влияет-на-плагины)
+ [Как тестировать плагины Jira DC?](jira.md#Как-тестировать-плагины-Jira-DC)

### Jira Cloud (Forge и Connect)
+ [Что такое Forge?](jira.md#Что-такое-Forge-и-как-создать-Forge-приложение)
+ [Что такое Connect и чем он отличается от Forge?](jira.md#Что-такое-Connect-и-чем-он-отличается-от-Forge)
+ [Как работает аутентификация в Jira Cloud?](jira.md#Как-работает-аутентификация-и-авторизация-в-Jira-Cloud-приложениях)

### Архитектура и практики
+ [Как проектировать приложение, совместимое с DC и Cloud?](jira.md#Как-проектировать-приложение-совместимое-с-DC-и-Cloud)
+ [Какие есть best practices при разработке для Jira?](jira.md#Какие-есть-best-practices-при-разработке-для-Jira)
+ [Что такое ScriptRunner?](jira.md#Что-такое-ScriptRunner-и-когда-его-использовать)
...
+ [Что такое Observability и чем она отличается от мониторинга?](observability.md#Что-такое-Observability-и-чем-она-отличается-от-мониторинга)
+ [Что такое метрики и какие типы метрик существуют?](observability.md#Что-такое-метрики-и-какие-типы-метрик-существуют)
+ [Что такое Micrometer и как его использовать в Spring Boot?](observability.md#Что-такое-Micrometer-и-как-его-использовать-в-Spring-Boot)
+ [Что такое Prometheus и как он собирает метрики?](observability.md#Что-такое-Prometheus-и-как-он-собирает-метрики)
+ [Что такое Grafana и как визуализировать метрики?](observability.md#Что-такое-Grafana-и-как-визуализировать-метрики)
+ [Что такое distributed tracing?](observability.md#Что-такое-distributed-tracing)
+ [Что такое OpenTelemetry?](observability.md#Что-такое-OpenTelemetry)
+ [Как настроить distributed tracing в Spring Boot?](observability.md#Как-настроить-distributed-tracing-в-Spring-Boot)
+ [Что такое Spring Boot Actuator?](observability.md#Что-такое-Spring-Boot-Actuator)
+ [Что такое алертинг и как его правильно настроить?](observability.md#Что-такое-алертинг-и-как-его-правильно-настроить)
+ [Что такое SLO, SLI и SLA?](observability.md#Что-такое-SLO-SLI-и-SLA)
+ [Как организовать centralized logging в микросервисах?](observability.md#Как-организовать-centralized-logging-в-микросервисах)

[к оглавлению](#java-developer-справочник-для-подготовки-к-собеседованию-middle)

## Кэширование
+ [Что такое кэширование и зачем оно нужно?](caching.md#Что-такое-кэширование-и-зачем-оно-нужно)
+ [Какие паттерны кэширования существуют?](caching.md#Какие-паттерны-кэширования-существуют)
+ [Что такое Redis и когда его использовать?](caching.md#Что-такое-Redis-и-когда-его-использовать)
+ [Какие структуры данных поддерживает Redis?](caching.md#Какие-структуры-данных-поддерживает-Redis)
+ [Как настроить Redis в Spring Boot?](caching.md#Как-настроить-Redis-в-Spring-Boot)
+ [Какие стратегии инвалидации кэша существуют?](caching.md#Какие-стратегии-инвалидации-кэша-существуют)
+ [Что такое многоуровневое кэширование (L1 + L2)?](caching.md#Что-такое-многоуровневое-кэширование-L1--L2)
+ [Что такое Cache Stampede и как его предотвратить?](caching.md#Что-такое-Cache-Stampede-и-как-его-предотвратить)
+ [Как работает HTTP-кэширование?](caching.md#Как-работает-HTTP-кэширование)
+ [Что такое Caffeine Cache?](caching.md#Что-такое-Caffeine-Cache)
+ [Как обеспечить согласованность кэша в распределённой системе?](caching.md#Как-обеспечить-согласованность-кэша-в-распределённой-системе)
+ [Какие политики вытеснения (eviction) существуют?](caching.md#Какие-политики-вытеснения-eviction-существуют)
...
## Git
+ [Что такое Git и чем он отличается от других систем контроля версий?](git.md#Что-такое-Git-и-чем-он-отличается-от-других-систем-контроля-версий)
+ [Какие основные команды Git нужно знать?](git.md#Какие-основные-команды-Git-нужно-знать)
+ [Что такое ветвление (branching) в Git?](git.md#Что-такое-ветвление-branching-в-Git)
+ [Какие стратегии ветвления существуют?](git.md#Какие-стратегии-ветвления-существуют)
+ [В чём разница между merge и rebase?](git.md#В-чём-разница-между-merge-и-rebase)
+ [Как разрешить конфликт при merge/rebase?](git.md#Как-разрешить-конфликт-при-mergerebase)
+ [Что такое cherry-pick?](git.md#Что-такое-cherry-pick)
+ [Что такое git stash?](git.md#Что-такое-git-stash)
+ [Что такое git reset, git revert и git checkout? В чём разница?](git.md#Что-такое-git-reset-git-revert-и-git-checkout-В-чём-разница)
+ [Что такое .gitignore и как его правильно настроить?](git.md#Что-такое-gitignore-и-как-его-правильно-настроить)
+ [Что такое git tag и зачем нужны теги?](git.md#Что-такое-git-tag-и-зачем-нужны-теги)
+ [Что такое git bisect?](git.md#Что-такое-git-bisect)
+ [Что такое git hooks?](git.md#Что-такое-git-hooks)
+ [Что такое Conventional Commits?](git.md#Что-такое-Conventional-Commits)
+ [Как отменить последний коммит?](git.md#Как-отменить-последний-коммит)
